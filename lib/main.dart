...
void showFirebaseInitializationError() {
  // This is only needed during development
  // When properly configured with Firebase, this won't be called
  debugPrint('''
  ---------------------------------------------------------------
  ⚠️ FIREBASE INITIALIZATION ERROR ⚠️
